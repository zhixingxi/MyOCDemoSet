...
public enum RichEditorDefaultOption: RichEditorOption {
    ...
    public static let all: [RichEditorDefaultOption] = [
        ...
        .alignLeft, .alignCenter, .alignRight, .image, .link, .textFont
    ]
    
    public static let customFunction: [RichEditorDefaultOption] = [.bold, .underline, .textFont, .textColor, .image]
    ...
    public var title: String {
        ...
        case .textFont: return NSLocalizedString("Font", comment: "")
    ...
    public func action(_ toolbar: RichEditorToolbar) {
        switch self {
        case .clear: toolbar.editor?.blur()
        case .undo: toolbar.editor?.undo()
        case .redo: toolbar.editor?.redo()
        case .bold:
            toolbar.editor?.bold()
            toolbar.delegate?.richEditorToolbarDisplayKeyboard?(toolbar)
        ...
        case .textFont: toolbar.delegate?.richEditorToolbarChangeTextFont?(toolbar)
        }
    }
}
